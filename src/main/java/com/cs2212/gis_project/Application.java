...
public class Application extends javax.swing.JFrame {
    ...
    private HashMap<Category, Boolean> activeLayers;
    ...
    public Application() {
        ...
        try {
           ...
           poi.setIcon(new ImageIcon(ImageIO.read(Application.class.getClassLoader().getResource("imgs/poi.png"))));
    ...
    private void mapShowButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mapShowButtonActionPerformed
        ...
        if(index < mapFiles.length) {
            ...
            mapFile =  Application.class.getClassLoader().getResource(mapFiles[index]);
